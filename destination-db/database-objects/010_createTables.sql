...
(
    ...
    DECOMMISSION_DATE   DATETIME   NOT NULL,
...
(
    REGISTER_ID          DECIMAL(12, 0) NOT NULL,
    INDIVIDUAL_ID        DECIMAL(12, 0) NULL,
    ORGANISATION_ID      DECIMAL(12, 0) NULL,
    REGISTER_CODE        DECIMAL(12, 0) NULL,
    PRN                  DECIMAL(12, 0) NULL,
    LAST_CHECK_TEST_DATE DATETIME       NULL,
    VEHICLE_TYPE_CODE    VARCHAR(12)    NULL,
    DATE_LAST_APPROVED   DATETIME       NOT NULL,
...
(
    HISTORY_ID                  DECIMAL(12, 0) NOT NULL,
    INDIVIDUAL_ID               DECIMAL(12, 0) NULL,
    REGISTER_ID                 DECIMAL(12, 0) NULL,
    APPLICATION_ID              DECIMAL(12, 0) NULL,
    EXAM_TYPE_CODE              DECIMAL(12, 0) NULL,
    DATE_OF_TEST                DATETIME       NULL,
    RESULT_CODE                 DECIMAL(12, 0) NULL,
    UPDATED_ON                  DATETIME       NULL,
    MARK                        DECIMAL(12, 0) NULL,
    THEORY_PASS_STATE_CODE      TINYINT        NULL,
    THEORY_TYPE_CODE            INT            NULL,
    GRADE_ID                    SMALLINT       NULL,
    BOOKING_ID                  DECIMAL(12, 0) NULL,
    ORIGINAL_CERTIFICATE_NUMBER DECIMAL(15, 0) NULL,
    CONSTRAINT PK_TEST_HISTORY PRIMARY KEY (HISTORY_ID)
);
...
(
    ...
    TEST_CATEGORY_REF      VARCHAR(10) NOT NULL,
    ENTITLEMENT_START_DATE DATETIME,
...
(
    ...
    CONSTRAINT APP_SYSTEM_PARAMETER_PK PRIMARY KEY (APP_SYS_PARAM_KEY, EFFECTIVE_FROM)
);

CREATE TABLE IF NOT EXISTS CHECK_TEST
(
    CHECK_TEST_ID                  DECIMAL(12, 0) NOT NULL,
    REGISTER_ID                    DECIMAL(12, 0) DEFAULT NULL,
    ANNOTATION                     VARCHAR(20)    DEFAULT NULL,
    BOOKING_CONFIRMED              TINYINT(4)     DEFAULT NULL,
    INVITATION_DATE                DATETIME       DEFAULT NULL,
    DATE_TEST                      DATETIME       DEFAULT NULL,
    TIME_TEST                      VARCHAR(255)   DEFAULT NULL,
    ELEMENTS_OF_TRAINING_INSPECTED VARCHAR(4)     DEFAULT NULL,
    CANNOT_ATTEND                  TINYINT(4)     DEFAULT NULL,
    SE_ID                          INT(11)        DEFAULT NULL,
    UNABLE_TO_CONTACT              TINYINT(4)     DEFAULT NULL,
    OTHER_ACTION_TAKEN             VARCHAR(250)   DEFAULT NULL,
    REPLACEMENT_BOOKING_DATE       DATETIME       DEFAULT NULL,
    REASON_FOR_NON_REPLACEMENT     VARCHAR(485)   DEFAULT NULL,
    RESULT                         DECIMAL(12, 0) DEFAULT NULL,
    CREATED_BY                     DECIMAL(12, 0) NOT NULL,
    CREATED_ON                     DATETIME       NOT NULL,
    UPDATED_BY                     DECIMAL(12, 0) NOT NULL,
    UPDATED_ON                     DATETIME       NOT NULL,
    CHECK_TEST_DATE                DATETIME       DEFAULT NULL,
    PAYMENT_DATE                   DATETIME       DEFAULT NULL,
    OFF_ROAD                       TINYINT(4)     DEFAULT NULL,
    ON_ROAD                        TINYINT(4)     DEFAULT NULL,
    TEST_CATEGORY_ID               DECIMAL(12, 0) DEFAULT NULL,
    CONSTRAINT CHECK_TEST_ID_PK PRIMARY KEY (CHECK_TEST_ID)
);
