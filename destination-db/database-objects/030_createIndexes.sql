...
CALL CreateIndex ('tarsreplica','ORGANISATION_REGISTER','IX_ORREG_REGCODE','register_code');
CALL CreateIndex ('tarsreplica','ORGANISATION_REGISTER','IX_ORREG_BRN','brn');
...
CALL CreateIndex ('tarsreplica','CHECK_TEST','IX_CHECKTEST_REGID','register_id');
CALL CreateIndex ('tarsreplica','APPLICATION','IX_APPLIC_IDX1','state_code,app_id');
CALL CreateIndex ('tarsreplica','APPLICATION','IX_APPLIC_INDID','individual_id');
CALL CreateIndex ('tarsreplica','APPLICATION','IX_APPLIC_ORDID','order_id');
CALL CreateIndex ('tarsreplica','APPLICATION','IX_APPLIC_STATECODE','state_code');
CALL CreateIndex ('tarsreplica','APPLICATION','IX_APPLIC_TSTSERVICEID','test_service_id');
CALL CreateIndex ('tarsreplica','APPLICATION','IX_APPLIC_VEHID','vehicle_id');
