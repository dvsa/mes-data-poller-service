...
import {info, customDurationMetric, error} from '@dvsa/mes-microservice-common/application/utils/logger';
    ...
    const results: ExaminerTestSlot[] = rows.map((r: any): ExaminerTestSlot => {
      const mappedData: ExaminerTestSlot = {
        ...
        testSlot: {
          ...
          vehicleSlotTypeCode: r.testslotVehicleSlotTypeCode != null ?
            Number(r.testslotVehicleSlotTypeCode) : undefined,
          testCentre: {
