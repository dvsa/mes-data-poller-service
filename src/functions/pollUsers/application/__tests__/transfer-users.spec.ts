...
import * as examinerRepository from '../../framework/repositories/get-active-examiners';
import * as universalPermissionsRepository from '../../framework/repositories/get-universal-permissions';
...
describe('transferUsers module', () => {
  ...
  beforeEach(() => {
    ...
    spyOn(universalPermissionsRepository, 'getUniversalTestPermissions').and.callFake(
      moqUniversalPermissionsRepository.object
    );
  });
  describe('transferUsers', () => {
    it(
      ...
      async () => {
        ...
        moqExaminerRepo
          .setup((x) => x(It.isValue(univeralPermissionPeriods)))
